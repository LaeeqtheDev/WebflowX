        ...
        <div className="h-full flex flex-col overflow-hidden bg-gray-50">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b bg-white shrink-0 shadow-sm">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <h1 className="text-base font-bold leading-none">Documents</h1>
                ...
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                        {docs.map(doc => (
                            <div
                                key={doc._id}
                                className="group relative flex flex-col gap-3 p-4 border rounded-xl cursor-pointer hover:shadow-md transition-all hover:border-[#ff5018]/30 bg-white"
                            ...
                            >
                                ...
                                <div className={cn(
                                    ...
                                    {doc.type === "spreadsheet"
                                        ? <FileSpreadsheet className="size-10 text-green-400" />
                                ...
                                {renamingId === doc._id ? (
                                    ...
                                    <p className="text-xs font-semibold truncate leading-none">{doc.title}</p>
                                )}
